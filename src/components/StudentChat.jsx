...
const StudentChat = () => {
  ...
  const fetchTeachers = async () => {
    ...
    try {
      const res = await axios.get("https://sof-edu-backend.onrender.com/student/teachers", {
  ...
  const fetchUnreadCounts = async () => {
    try {
      const res = await axios.get(
        "https://sof-edu-backend.onrender.com/student/messages/unread-counts",
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const fetchMessagesWithTeacher = async (teacherId) => {
    ...
    try {
      const res = await axios.get(
        `https://sof-edu-backend.onrender.com/student/messages/teacher?teacherId=${teacherId}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const fetchMessagesWithAdmin = async () => {
    ...
    setMessages([]);
    try {
      const res = await axios.get("https://sof-edu-backend.onrender.com/student/messages/admin", {
        headers: { Authorization: `Bearer ${token}` },
      });
      const formatted = res.data.map((msg) => ({
        ...msg,
  ...
  try {
    const url = isAdminChat
      ? "https://sof-edu-backend.onrender.com/student/messages/admin"
      : "https://sof-edu-backend.onrender.com/student/messages/teacher";
  ...
  const handleUpdateMessage = async () => {
    ...
    try {
      await axios.put(
        `https://sof-edu-backend.onrender.com/student/editMessage/${editingMessageId}`,
        { newText: text },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleDeleteMessage = async (id) => {
    ...
    try {
      await axios.delete(`https://sof-edu-backend.onrender.com/student/deleteMessage/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
